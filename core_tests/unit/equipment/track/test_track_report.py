...
python -m unittest -v unit/equipment/track/test_track_state.py
...
class TestTrackReport(unittest.TestCase):

    def test_track(self):
        mode = TrackMode.POWER_ON
        obj1 = TrackReport(mode)
    ...
    def test_track_str(self):
        mode = TrackMode.POWER_ON
        obj1 = TrackReport(mode)
        self.assertEqual('TrackReport:{mode:POWER_ON}', str(obj1))
    ...
    def test_turnout_jstr(self):
        ...
        self.assertEqual('{"type": "TrackReport", "mode": "SHORT_CIRCUIT"}', jstr)
    ...
    def test_turnout_jstr_eq(self):
        ...
        obj1 = TrackReport(mode)
        jstr = JSONify.dumps(obj1)
        obj2 = TrackReport.construct_from_jdict(json.loads(jstr))
